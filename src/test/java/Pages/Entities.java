...
public class Entities {
	...
	public void ExportAll() throws Exception {
		...
		waitEle(By.xpath("//button[@class='el-tooltip btn btn-sm btn-outline-secondary m-lr-1 export-button']"));
...
//		form rule-2
	...
	public void AddDatato1553() throws Exception {
		...
		WebElement EntityField = driver.findElement(By.xpath("//td[@class='el-table_29_column_140   el-table__cell']//span"));
