...
public class Recieverside {
	static WebDriver driver;

	public Recieverside(WebDriver driver) {
		Recieverside.driver = driver;
	}
...
//		switchEmail();
	...
	public void processDocument(String email, String password, String emailSubject, String signerName, boolean isApprover) throws Exception {
	    ...
	    Thread.sleep(10000);
	    String xpath = String.format("//span[contains(text(), '%s')]", emailSubject);
	    waitEle(By.xpath(xpath));
	    ...
	    Thread.sleep(10000);
	    String Parentwindowid1 = driver.getWindowHandle();
	    waitEle(By.xpath("//a[text()=\"Review & " + (isApprover ? "Approve" : "sign") + "\"]"));
	    Thread.sleep(10000);
	    Set<String> allwindowhandles1 = driver.getWindowHandles();
	    for (String childwindow : allwindowhandles1) {
	        if (!childwindow.endsWith(Parentwindowid1)) {
	    ...
	    Thread.sleep(1000);
	    sendKeysToElement(By.xpath("//input[@placeholder='Enter signature']"), signerName);
	    waitEle(By.xpath("//div[@id='pane-letter']//button[1]"));
	    waitEle(By.xpath("//span[normalize-space()='Verify & Save Secure Signature']"));

	    if (isApprover) { 
	        Thread.sleep(10000);
	        Javascriptclick(By.xpath("//button[@class='el-button finish-drawer-finish el-button--success el-button--mini']"));
	    }else {
	...
	public void VerifyAllloginCredantials() throws Exception {
	    processDocument("jeevithapatnana200@outlook.com", "Meghana@123", "RunningInLoop", "Jeevitha", true);
	    processDocument("ramyasibbala200@outlook.com", "Meghana@123", "RunningInLoop", "Ramya", false);
	    processDocument("meghanan180894@outlook.com", "Meghana@123", "RunningInLoop", "Sathya", false);
	    processDocument("pmmeghana200@outlook.com", "Meghana@123", "RunningInLoop", "Tejasri", false);
	    processDocument("ramyas200@outlook.com", "Meghana@123", "RunningInLoop", "Arshiya", false);
	    processDocument("ramyas2002@outlook.com", "Ramya@123", "RunningInLoop", "Madhurima", false);
	    processDocument("esigns100@outlook.com", "Ramya@123", "RunningInLoop", "Gayathri", false);
	    processDocument("esigns200@outlook.com", "Ramya@123", "RunningInLoop", "Sathvik", false);
	    processDocument("esigns300@outlook.com", "Ramya@123", "RunningInLoop", "Niharika", false);
	    processDocument("esigns400@outlook.com", "Ramya@123", "RunningInLoop", "Pooja", false);
	}
...
//			waitEle(By.xpath("//span[normalize-space()='NEXT FIELD']"));
	...
	public void FinishDocumentRecieverside() throws InterruptedException {
		waitEle(By.xpath("//span[text()=\"FINISH\"]"));
		System.out.println("Review and Sign successful");
